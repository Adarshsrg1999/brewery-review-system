...
// const url = process.env.MONGO_DB_URL || `mongodb+srv://Adarsh:<${process.env.MONGODB_PASSWORD}>@cluster0.baambk7.mongodb.net/?retryWrites=true&w=majority`;
...
const url = process.env.MONGO_DB_URL || 'mongodb+srv://adarsh:<password>@c1.jsumajj.mongodb.net/';
const client = new MongoClient(url);

const DB_NAME = process.env.DB_NAME || "c1";
const DB_COLLECTION_NAME = process.env.DB_COLLECTION_NAME || "userData";
const db = client.db(DB_NAME);
const coll = db.collection(DB_COLLECTION_NAME);
